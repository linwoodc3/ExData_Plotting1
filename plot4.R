...
# set outer margins
par(mar = c(4,3.8,3.8,1),oma=c(0,0,0,0), mfcol =c(2,2))
...
# top right plot
plot( plotdata$newdate, plotdata$Voltage, ylab = "Voltage", xlab= "datetime", type="l", main="")

# bottom right plot
plot( plotdata$newdate, plotdata$Global_reactive_power, ylab = "Global_reactive_power", xlab= "datetime", type="l", main="")

# Add text to top left corner
mtext("Plot 4",adj=0, outer = TRUE)
